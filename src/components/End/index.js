...
const End = (state, send) => {
  ...
  return yo`<div class="End Card">
  	...
  	<div class="h2">To see how ${state.wasCompletedManually ? 'your' : 'these'} answers stack up to the results, copy this unique code or email it to yourself and ${state.isLocked ? 'check back later' : 'come back once the Oscars have begun'}:</div>
  	${EndCode(state.code)}
